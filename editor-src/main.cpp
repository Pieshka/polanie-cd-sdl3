...
//if(ladowanie()) {FreeBuffers13h();ClearText13h(); cprintf("BLAD !!!\n\r----------- Brak pliku SETUP.INI.  Uruchom program SETUP.EXE.-----------\n"); return; }
//----------------------------------------------------------------------------

//--------------------------------------------

cprintf("\n\rAlokacja pamieci niskiej - grafika..................................  \n\r");
if(GetMemory()){FreeBuffers13h();ClearText13h();cprintf("BLAD !!!\n\rBrak pamieci operacyjnej. \n\rProgram wymaga 586kB RAM\n"); return 1;} // [PORT] main must return int
...
Init13h();
    if(InitText13h()){FreeBuffers13h();Close13h();cprintf("Blad inicjacji pamieci na czcionki, lub brak pliku FONT.DAT");return 1;} // [PORT] main must return int // [PORT] Moved from line 77
SetScreen(0);
//ShowIntro();
