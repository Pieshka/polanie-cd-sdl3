...
if(drewno[2]!=NULL)GetImage13h(299,41,314,150,drewno[2]);
        else {Close13h();cprintf("ERROR 3. Bitmap allocation failed. Wood 0");return;} // [PORT] [TODO] Replace exit with return. Not the best way but the easiest
...
if(button)PutImage13h(274,-2+20*button,Buttons[2],1);
...
if(co<10)
        ...
        if(co==4&&food>79){PutImage13h(275,61,missiles[2][1][2],1);
        ...
        if(co==3&&food>79){PutImage13h(275,60,missiles[1][1][2],1);//deszcz
                           PutImage13h(271,59,missiles[1][1][2],1);//deszcz
                           PutImage13h(279,59,missiles[1][1][2],1);}//deszcz
        if(co==3&&food>49)PutImage13h(275,79,picture[278],1);//tarcza
        if(co==1&&button==2)PutImage13h(275,59,buttons[8],1);//topornik-odbudowa
        }
}
///////////////////////////////////////////////////////////////////////
...
//unsigned char *txt[5]={"Spiel speichern","Spiel laden","Wiederhole Mission","Zur^ck zum Spiel","Spiel beenden"};
...
CenterText13h(10,Ty[1]-1,10+300,Ty[1]+13,"Naprawde chcesz skonczyc gre?",79);
RisePalette(0);
}
...
//if(t){Close13h();cprintf("Fehler 303. Zu wenig Arbeitsspeicher.\n\r Ben”tigt werden 586 KB freien Arbeitsspeicher.\n\r");return;} // [PORT] [TODO] Replace exit with return. Not the best way but the easiest
}
///////////////////////////////////////////////////////////////
